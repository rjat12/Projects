...
public class Javaproj extends JFrame implements ActionListener{
    
    JButton b1, b2;
    JTextField t1;
    Javaproj(){
        setBounds(500, 100, 1000, 800); // dleft, //dup // length, height ///////
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("mini/code/icons/login.png"));
